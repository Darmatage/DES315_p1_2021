...
public class AustinSteadMonsterShootMove : MonoBehaviour
{
    ...
    {
		AustinSteadProjectile projectile = collision.gameObject.GetComponent<AustinSteadProjectile>();
		if (projectile != null && projectile.GetTeam() == AustinSteadProjectile.Team.Player)
        {
			EnemyLives -= 1;
